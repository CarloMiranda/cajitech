        ...
        <section className="about section-padding prelative" data-scroll-index='1'>
            <div className="container mt-5">
                ...
                <div className="col-md-12">
                    ...
                    <p>We are a community driven by the relentless pursuit of excellence. Join us in shaping the future, where every idea is a catalyst for transformation.</p>
                    </div>
                    <div className="section-content text-center">
                    <div className="row">
                        <div className="col-md-4">
                        <div className="icon-box" data-aos="zoom-in" data-aos-duration="2000"> <i><FontAwesomeIcon className='icon' icon={faPhone} /></i> 
                            <h5>Support</h5>
                        ...
                        <div className="col-md-4">
                        <div className="icon-box" data-aos="zoom-in" data-aos-duration="2500"> <i aria-hidden="true"><FontAwesomeIcon className='icon' icon={faMobile} /></i>
                        ...
                        <div className="col-md-4">
                        <div className="icon-box" data-aos="zoom-in" data-aos-duration="3000"> <i className="fa fa-bolt" aria-hidden="true"><FontAwesomeIcon className='icon' icon={faBolt} /></i>
                            <h5>Fast</h5>
