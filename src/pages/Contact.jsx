        ...
        <section className="contact section-padding" data-scroll-index='6'>
            <div className="container mt-5">
                ...
                <div className="col-md-12">
                    ...
                    <p>Have questions, feedback, or just want to say hello? We're here and ready to listen. Your thoughts matter, and we're committed to providing the best possible experience for you. Reach out to us via the form below, and we'll get back to you as soon as possible. Thank you for choosing Cajitech. We appreciate your trust and look forward to connecting with you!</p>
                    </div>
