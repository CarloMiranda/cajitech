                ...
                <div className="col-md-12">
                    ...
                    <div className="row">
                        <div className="col-md-4 col-sm-12">
                            <div className="media single-feature" data-aos="fade-right" data-aos-duration="1000">
                            ...
                            <div className="media single-feature" data-aos="fade-right" data-aos-duration="2000">
                                <div className="media-body text-right media-right-margin">
                            ...
                            <div className="media single-feature" data-aos="fade-right" data-aos-duration="3000">
                                <div className="media-body text-right media-right-margin">
                                <h5>User Friendly</h5>
                            ...
                            <div className="col-md-4 d-none d-md-block d-lg-block" data-aos="fade-up" data-aos-duration="1000">
                                <div className="feature-mobile"> <img src="images/iphone-screen-with-shadow.png" className="img-fluid"/> </div>
                            </div>
                        <div className="col-md-4 col-sm-12">
                            <div className="media single-feature" data-aos="fade-left" data-aos-duration="1000">
                            ...
                            <div className="media single-feature" data-aos="fade-left" data-aos-duration="2000">
                            ...
                            <div className="media single-feature" data-aos="fade-left" data-aos-duration="3000">
